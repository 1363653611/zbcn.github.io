    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://github.com/1363653611/myBlog/tree/develop/blogSrc/blogPhoto/min_photos/' + data.link[i];
          var src = 'https://github.com/1363653611/myBlog/tree/develop/blogSrc/blogPhoto/photos/' + data.link[i];
