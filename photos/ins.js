...
([
  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://raw.githubusercontent.com/1363653611/myBlog/develop/blogSrc/blogPhoto/min_photos/' + data.link[i];
          var src = 'https://raw.githubusercontent.com/1363653611/myBlog/develop/blogSrc/blogPhoto/photos/' + data.link[i];
          ...
          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">\
                <a href="' + src + '" itemprop="contentUrl" data-size="1080x1080" data-type="' + type + '" data-target="' + src + '">\
                  <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="/zbcn.github.io/zbcn.github.io/photos/ins.j/assets/img/empty.png" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
    ...
    var replacer = function replacer(str) {
      var arr = str.split("/");
      return "/zbcn.github.io/assets/ins/" + arr[arr.length - 1];
    };
